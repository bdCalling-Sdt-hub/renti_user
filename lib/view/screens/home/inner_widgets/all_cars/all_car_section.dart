                                              ...
                                              Container(
                                                ...
                                                decoration: ShapeDecoration(
                                                  image: controller
                                                      ...
                                                      ? DecorationImage(
                                                          image: NetworkImage(
                                                              "${ApiUrlContainer.imageUrl}${controller.luxuryCarList[index].image![0].toString()}"),
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        CustomText(
                                                          left: 8,
                                                          text:
                                                              "${controller.luxuryCarList[index].totalRun.toString()}${"/L"}",
                                                          color: AppColors
                                                              .whiteDark,
                                                          fontSize: 10,
                                                          fontWeight:
                                                      ...
                                                      children: [
                                                        RichText(
                                                            text: TextSpan(
                                                              ...
                                                              TextSpan(
                                                                text:
                                                                    "${"\$"}${controller.luxuryCarList[index].hourlyRate.toString()}",
                                                                style:
                                                                    GoogleFonts
                                                                        .poppins(
                                                                  color: const Color(
