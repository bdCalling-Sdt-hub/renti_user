...
import 'package:renti_user/view/screens/rent_history/rent_history_controller/rent_controller.dart';
                  ...
                  Expanded(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            CustomText(
                              text: '\$ ${controller.carList[index].totalAmount}',
                              fontSize: 18,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                CustomText(
                                  text: DateConverter.isoStringToLocalFormattedDateOnly(controller.carList[index].startDate.toString()),
                                  fontSize: 12,
                                  color: AppColors.whiteDarkActive,
                                  bottom: 8,
                                  left: 10,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                CustomText(
                                  text: controller.carList[index].carId!.carModelName.toString(),
                                  fontSize: 12,
                                  color: AppColors.whiteDarkActive,
                                  left: 10,
                                )
