...
class ChangePasswordController extends GetxController{
  ...
  Future<void> changePassword() async{
    ...
    ApiResponseModel responseModel = await repo.changePassword(currentPassword: currentPasswordController.text, newPassword: newPasswordController.text, retypePassword: confirmPasswordController.text);
