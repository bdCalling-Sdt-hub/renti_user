...
import 'package:renti_user/view/widgets/drawer/custom_drawer_controller/custom_drawer_controller.dart';
import 'package:renti_user/view/widgets/drawer/custom_drawer_repo/custom_drawer_repo.dart';
...
class _CustomDrawerState extends State<CustomDrawer> {
  ...
  void initState() {
    ...
    Get.put(CustomDrawerRepo(apiService: Get.find()));
    Get.put(CustomDrawerController(customDrawerRepo: Get.find()));
    super.initState();
  }
  @override
